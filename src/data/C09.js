  ...
  module: [
    {
      ...
      lektionen: [
        {
          id: 'C09-M1-L1',
          titel: 'Die Stresslandschaft der Führungskraft',
          inhalt: `Führungskräfte leben in einem permanenten Spannungsfeld — zwischen den Erwartungen von oben, den Bedürfnissen von unten, dem Druck des Marktes und den eigenen Ansprüchen. Diese Mehrfachbelastung erzeugt eine spezifische Stressqualität, die sich von der eines Angestellten fundamental unterscheidet und andere Coaching-Strategien erfordert.

Die typischen Stressoren von Führungskräften: Entscheidungsdruck — täglich Dutzende Entscheidungen treffen, oft unter Zeitdruck und mit unvollständigen Informationen. Verantwortungslast — nicht nur für die eigene Leistung, sondern für die Ergebnisse des gesamten Teams oder der Abteilung. Konflikte navigieren — zwischen Mitarbeitern, zwischen Abteilungen, zwischen den eigenen Werten und den Unternehmenszielen. Ständige Erreichbarkeit — die Grenze zwischen Arbeit und Privatleben verschwimmt, das Handy klingelt auch am Wochenende. Isolation — je höher die Position, desto weniger Menschen, mit denen man offen über Zweifel, Ängste und Überforderung sprechen kann. Und der unsichtbare Vertrag — die Erwartung, immer stark, souverän und belastbar zu wirken.
...
Stressoren (bewerte 1–10):
Entscheidungsdruck: ___
Verantwortungslast: ___
Konflikte: ___
Erreichbarkeit: ___
Isolation: ___
Rollendruck (stark wirken müssen): ___
Zeitdruck: ___
Unsicherheit/Veränderung: ___

Top-3-Stressoren: ___

Stresssymptome:
Körperlich: ___
Emotional: ___
Kognitiv: ___
Verhaltensbezogen: ___

Bisherige Bewältigungsstrategien:
Was funktioniert: ___
Was nicht funktioniert (aber trotzdem getan wird): ___

Die Lücke: Was fehlt? ___`,
            dauer: '10 Min',
          },
        },
        {
          id: 'C09-M1-L2',
          titel: 'Stressmodelle für die Coaching-Praxis',
          inhalt: `Führungskräfte denken in Modellen und Frameworks — sie sind es gewohnt, komplexe Situationen zu analysieren und systematisch zu bearbeiten. Stressmodelle geben dem diffusen Erleben von Stress eine Struktur und machen es handhabbar. Drei Modelle sind besonders nützlich für das Coaching.
...
ANFORDERUNGEN (Was kostet mich Energie):
1. ___ (Belastungslevel 1–10: ___)
2. ___
3. ___
4. ___
5. ___
Gesamt-Anforderungslevel: ___

RESSOURCEN (Was gibt mir Energie):
1. ___ (Stärkelevel 1–10: ___)
2. ___
3. ___
4. ___
5. ___
Gesamt-Ressourcenlevel: ___

BILANZ: Anforderungen minus Ressourcen = ___
Positiv = Überlastung. Negativ = Puffer vorhanden. Null = Grenzbereich.

HEBELPUNKTE:
Welche Anforderung kann ich reduzieren oder delegieren? ___
Welche Ressource kann ich stärken oder aktivieren? ___

Dieser eine Hebel, den ich diese Woche umsetze: ___`,
            dauer: '15 Min',
          },
        },
        {
...
□ Schlaf erholt mich nicht mehr richtig
□ Auch am Wochenende oder im Urlaub kann ich nicht abschalten
□ Ich fühle mich körperlich erschöpft ohne erkennbaren Grund

Zynismus:
□ Ich empfinde weniger Freude an meiner Arbeit als früher
□ Ich reagiere zunehmend gereizt auf Kollegen oder Klienten
□ Ich denke oft: „Ist doch alles sinnlos"
□ Ich distanziere mich emotional von meiner Arbeit

Leistungsfähigkeit:
□ Ich brauche für gleiche Aufgaben mehr Zeit als früher
□ Ich mache mehr Fehler als gewöhnlich
...
Technik 3 — Kalt-Wasser-Reset:
30 Sek kaltes Wasser auf den Handgelenken.
Wirkung: ___

Technik 4 — 5-4-3-2-1 Erdung:
5 sehen, 4 hören, 3 berühren, 2 riechen, 1 schmecken.
Wirkung: ___

Meine Top-2-Techniken (die ich ab jetzt immer parat habe):
1. ___
2. ___

Mein Trigger für den Einsatz: „Jedes Mal, wenn ich merke, dass ___, wende ich ___ an."`,
            dauer: '15 Min',
          },
        },
        {
          id: 'C09-M2-L2',
          titel: 'Gedankenmanagement unter Druck',
          inhalt: `Stress entsteht nicht durch die Situation — er entsteht durch die Gedanken über die Situation. Ein überfüllter Kalender ist ein Fakt — „Ich schaffe das nie" ist ein Gedanke. Eine schwierige Verhandlung ist ein Fakt — „Wenn ich scheitere, ist alles vorbei" ist ein Gedanke. Die Fähigkeit, unter Druck die eigenen Gedanken zu erkennen und zu steuern, ist die wertvollste Stressmanagement-Kompetenz für Führungskräfte.
...
Die Gedankenstopp-Umlenkung: Wenn ein destruktiver Gedanke auftaucht, sagst du innerlich „Stopp" und lenkst die Aufmerksamkeit bewusst auf eine produktive Frage: „Was ist jetzt der nächste sinnvolle Schritt?" „Was liegt in meiner Kontrolle?" „Was wäre die Empfehlung, die ich einem guten Freund in meiner Situation geben würde?" Diese Umlenkung nutzt die gleiche mentale Energie, die der Stressgedanke verbraucht hätte — aber produktiv statt destruktiv.

Die Perspektivwechsel-Technik für Entscheidungsdruck: „Wie werde ich in fünf Jahren auf diese Entscheidung zurückblicken?" „Was würde ich meinem Nachfolger raten?" „Was ist die mutigste Entscheidung — und was die klügste?" Diese Perspektivwechsel lösen den Tunnelblick, den akuter Stress erzeugt, und öffnen den Zugang zu deiner eigentlichen Führungskompetenz.`,
          uebung: {
            titel: 'Stressgedanken umschreiben',
            anleitung: `Identifiziere drei aktuelle Stressgedanken und transformiere sie:

Stressgedanke 1: ___
Defusion: „Ich habe gerade den Gedanken, dass ___"
Worst/Best/Wahrscheinlich: ___/___/___
Produktive Frage stattdessen: ___

Stressgedanke 2: ___
Defusion: ___
Worst/Best/Wahrscheinlich: ___
Produktive Frage: ___
...
Übe die Defusion heute dreimal — jedes Mal, wenn ein Stressgedanke auftaucht, formuliere ihn um: „Ich habe gerade den Gedanken, dass..." Beobachte, was passiert.`,
            dauer: '10 Min',
          },
        },
        {
          id: 'C09-M2-L3',
          titel: 'Energie-Management statt Zeit-Management',
          inhalt: `Die meisten Führungskräfte versuchen, Stress durch besseres Zeitmanagement zu lösen — noch effizienter planen, noch enger takten, noch mehr in weniger Zeit quetschen. Das Problem: Die Zeit ist endlich, aber die Aufgaben sind unendlich. Egal wie gut du deine Zeit managst — du wirst nie alles schaffen. Der Paradigmenwechsel: Manage nicht deine Zeit — manage deine Energie.

Das Energie-Management-Modell unterscheidet vier Energiequellen: Körperliche Energie — Schlaf, Ernährung, Bewegung. Emotionale Energie — positive Beziehungen, Selbstfürsorge, emotionale Sicherheit. Mentale Energie — Fokus, Klarheit, kreatives Denken. Und Sinn-Energie — Purpose, Werte, Bedeutung. Jede dieser Quellen kann voll, halb voll oder leer sein — und der Gesamtzustand bestimmt deine Leistungsfähigkeit weit mehr als dein Kalender.
...
Die Energie-Räuber identifizieren: Welche Meetings, Aufgaben, Personen und Gewohnheiten rauben dir überproportional viel Energie? Das stundenlange Meeting, in dem nichts entschieden wird. Der Kollege, der jedes Gespräch in eine Klagesitzung verwandelt. Die E-Mail-Lawine, die den Morgen auffrisst. Die Identifikation und Reduktion von Energieräubern hat oft einen größeren Effekt als das Hinzufügen neuer Energiequellen.`,
          uebung: {
            titel: 'Energie-Audit',
            anleitung: `Führe ein Tages-Energie-Audit durch:

Notiere jede Stunde (oder alle zwei Stunden) deinen Energielevel von 1–10:

7 Uhr: ___ | 9 Uhr: ___ | 11 Uhr: ___ | 13 Uhr: ___
15 Uhr: ___ | 17 Uhr: ___ | 19 Uhr: ___ | 21 Uhr: ___

Mein Energiehoch: ___ Uhr
Mein Energietief: ___ Uhr

Was mache ich aktuell in meinem Energiehoch? ___
Was sollte ich dort machen? ___

Meine Top-3-Energieräuber:
1. ___
2. ___
3. ___

Meine Top-3-Energiequellen:
1. ___
2. ___
3. ___

Ein Energieräuber, den ich diese Woche eliminiere oder reduziere: ___
Eine Energiequelle, die ich diese Woche aktiviere: ___`,
            dauer: 'Beobachtung über den Tag, 10 Min Auswertung',
          },
        },
      ],
    },
    {
      ...
      lektionen: [
        {
          id: 'C09-M3-L1',
          titel: 'Die vier Säulen der Führungskräfte-Resilienz',
          inhalt: `Resilienz für Führungskräfte ist kein einmaliges Training — es ist eine tägliche Praxis, die auf vier Säulen ruht. Wenn eine Säule schwächelt, gerät das gesamte System ins Wanken. Die gute Nachricht: Jede Säule ist trainierbar, und die Stärkung einer einzelnen Säule hat positive Ausstrahlungseffekte auf die anderen.
...
Bewegung: ___
Ernährung: ___
Durchschnitt körperlich: ___

Emotional (1–10):
Vertrauensperson vorhanden: ___
Selbstmitgefühl: ___
Emotionale Offenheit: ___
Durchschnitt emotional: ___

Mental (1–10):
Fokus unter Druck: ___
Achtsamkeitspraxis: ___
Gedankenklarheit: ___
Durchschnitt mental: ___

Sinn (1–10):
Verbindung zum Purpose: ___
Werte-Kongruenz: ___
Sinnerleben: ___
Durchschnitt Sinn: ___

Schwächste Säule: ___
Eine Maßnahme zur Stärkung: ___
Start: Diese Woche.`,
            dauer: '10 Min',
          },
        },
        {
          id: 'C09-M3-L2',
          titel: 'Grenzen setzen und Nein sagen',
          inhalt: `Die Fähigkeit, Grenzen zu setzen und Nein zu sagen, ist für Führungskräfte eine der schwierigsten und gleichzeitig wichtigsten Stressmanagement-Kompetenzen. Die Kultur in vielen Unternehmen belohnt Ja-Sagen, Verfügbarkeit und Aufopferung — wer Nein sagt, gilt als nicht teamfähig, nicht belastbar oder nicht engagiert. Dieses System zu durchbrechen erfordert Mut und Strategie.

Warum Nein-Sagen so schwer ist: Die Angst vor negativen Konsequenzen — Ablehnung, Karrierenachteile, Konflikte. Der Wunsch, gebraucht zu werden — das Ego wird durch jede Anfrage gestreichelt. Die Überschätzung der eigenen Kapazität — „Das schaffe ich noch." Und die Unfähigkeit, die eigenen Grenzen zu spüren — viele Führungskräfte haben so lange ihre Grenzen ignoriert, dass sie sie nicht mehr wahrnehmen.

Das strategische Nein: Nein-Sagen heißt nicht, alles abzulehnen — es heißt, bewusst zu wählen. Die Grundfrage vor jeder Zusage: „Wenn ich hierzu Ja sage — wozu sage ich dann Nein?" Jedes Ja zu einer neuen Aufgabe ist ein Nein zu einer bestehenden Priorität — oder zu deiner Erholung. Diese Kosten-Bewusstheit verändert die Entscheidungsgrundlage.

Die Formulierung des Neins: Direkt, respektvoll und ohne Übererklärung. „Das kann ich in diesem Zeitrahmen nicht leisten." „Meine Kapazitäten sind aktuell voll — ich kann das frühestens in zwei Wochen übernehmen." „Das liegt nicht in meinem Verantwortungsbereich — [Name] wäre der bessere Ansprechpartner." Keine Entschuldigung, keine Rechtfertigung — eine klare, sachliche Aussage. Das Nein wird leichter, wenn du es als Ja zu deinen Prioritäten rahmst: „Ich sage Nein zu dieser Anfrage, damit ich Ja zu meinem wichtigsten Projekt sagen kann."
...
Meine nicht-verhandelbaren Grenzen (die ich ab sofort schütze):
1. ___
2. ___
3. ___

Wo sage ich aktuell Ja, obwohl ich Nein sagen sollte?
1. ___
2. ___
3. ___

Für jedes dieser Ja: Was kostet es mich? Welche Priorität leidet?
1. Kosten: ___
2. Kosten: ___
3. Kosten: ___

Meine Nein-Formulierung (übe sie laut):
„___"

Meine digitale Grenze:
Ab wann bin ich abends nicht mehr erreichbar? ___
Welcher Tag ist komplett arbeitsfrei? ___
Wo liegt mein Handy nachts? ___

Ein Nein, das ich diese Woche ausspreche: ___`,
            dauer: '15 Min',
          },
        },
        {
...
Methode: Atem-Anker-Meditation
Zeitpunkt: Wähle eine feste Zeit: ___ (z.B. morgens vor dem Aufstehen, mittags, abends)
Ort: ___

Tag 1–10: Zehn Minuten sitzen, Augen schließen, Atem beobachten.

Dokumentiere jeden Tag:
- Habe ich es geschafft? (Ja/Nein)
- Wie war es? (1–10 für Ruhe)
- Wie oft bin ich abgeschweift? (Schätzung)
- Wie fühle ich mich danach im Vergleich zu vorher?

Nach zehn Tagen:
- An wie vielen Tagen habe ich meditiert? ___/10
- Was hat sich verändert — Schlaf, Fokus, Stresslevel, Stimmung?
- Will ich weitermachen? Wenn ja: Verlängerung auf 30 Tage.

Die Herausforderung ist nicht die Meditation — sie ist die Regelmäßigkeit. Zehn von zehn Tagen ist das Ziel. Acht von zehn ist immer noch gut. Alles unter fünf: Die Zeit oder der Ort stimmt nicht — passe an und starte neu.`,
...
Die Vertraulichkeit: Besonders wichtig im Führungskräfte-Kontext. Alles, was in der Sitzung besprochen wird, bleibt in der Sitzung — auch wenn das Coaching vom Unternehmen bezahlt wird. Kläre das explizit in der ersten Sitzung. Ohne Vertrauen in die Vertraulichkeit wird keine Führungskraft über ihre Ängste, Zweifel und Überforderung sprechen.`,
          uebung: {
            titel: 'Erstgespräch-Simulation',
...
2. Drei Fragen, die du stellst:
   a) ___
   b) ___
   c) ___

3. Stresseinschätzung — Wie ordnest du seine Situation ein? ___

4. Zielvereinbarung — Was schlägst du als Ziel vor? ___

5. Erster Schritt — Was ist die eine Sache, die er bis zur nächsten Sitzung tun soll? ___`,
            dauer: '15 Min',
          },
        },
        {
...
Pausen und Erholung als Führungskultur: Wenn die Führungskraft selbst Pausen macht, Feierabend hat und in den Urlaub geht — ohne erreichbar zu sein —, gibt sie dem Team die Erlaubnis, dasselbe zu tun. Die Führungskraft als Vorbild für gesundes Arbeiten zu positionieren ist nicht nur gut für sie selbst — es verändert die gesamte Teamkultur.`,
          uebung: {
            titel: 'Delegations-Analyse',
            anleitung: `Analysiere deine aktuellen Aufgaben — oder die eines fiktiven Führungskräfte-Klienten:

Liste zehn wiederkehrende Aufgaben auf und ordne sie zu:

Aufgabe | Nur ich? | Delegierbar? | An wen?
1. ___ | □ | □ | ___
2. ___ | □ | □ | ___
3. ___ | □ | □ | ___
4. ___ | □ | □ | ___
...
Ehrliche Frage: Wie viele der „Nur ich"-Aufgaben sind wirklich nur von dir machbar — und wie viele sind es nur, weil du loslassen müsstest?

Eine Aufgabe, die ich diese Woche delegiere: ___
Was hindert mich? ___
Was gewinne ich, wenn ich es trotzdem tue? ___`,
            dauer: '15 Min',
          },
        },
        {
          id: 'C09-M4-L3',
          titel: 'Work-Life-Integration statt Work-Life-Balance',
          inhalt: `Der Begriff Work-Life-Balance suggeriert, dass Arbeit und Leben zwei getrennte Bereiche sind, die in ein Gleichgewicht gebracht werden müssen — wie zwei Schalen einer Waage. Für viele Führungskräfte ist dieses Modell unrealistisch — ihre Arbeit ist ein wesentlicher Teil ihres Lebens, und die strikte Trennung erzeugt mehr Stress als sie löst. Work-Life-Integration ist der realistischere Ansatz: Wie gestalte ich mein Leben so, dass Arbeit und Privatleben sich gegenseitig nähren statt aufzehren?

Integration statt Separation: Statt starre Grenzen zu ziehen — „ab achtzehn Uhr keine Arbeit" — sucht Integration flexible Lösungen: Morgens mit den Kindern frühstücken und dafür abends eine Stunde arbeiten. Mittags laufen gehen statt am Schreibtisch zu essen und dafür den Feierabend um dreißig Minuten nach hinten verschieben. Ein Tag Homeoffice, an dem die Wäsche nebenbei läuft. Nicht starr, sondern fließend — aber bewusst.

Die Grenze der Integration: Integration funktioniert nur, wenn sie bewusst geschieht — nicht als Dauerverschmelzung, in der beides gleichzeitig und keines richtig gemacht wird. Die Grenze liegt dort, wo du nie ganz bei dem bist, was du tust — am Schreibtisch denkst du an die Kinder, bei den Kindern denkst du an die Arbeit. Integration braucht Präsenz: Wenn du arbeitest, arbeite. Wenn du mit der Familie bist, sei mit der Familie. Nicht die Zeit ist das Problem — die geteilte Aufmerksamkeit ist das Problem.

Die Werte-Klarheit ist die Grundlage jeder Integration: Was ist dir wirklich wichtig? Nicht theoretisch, sondern praktisch — gemessen daran, wohin deine Zeit, deine Energie und deine Aufmerksamkeit fließen? Viele Führungskräfte sagen, Familie sei ihnen am wichtigsten — und investieren neunzig Prozent ihrer wachen Stunden in die Arbeit. Die Diskrepanz zwischen proklamierten und gelebten Werten ist eine der schmerzhaftesten Erkenntnisse im Coaching — und eine der transformativsten.

Die Praktische Übersetzung: Was müsste sich in meinem Alltag ändern, damit meine Zeitverteilung meinen Werten entspricht? Diese Frage ist einfach gestellt und schwer beantwortet — weil sie oft strukturelle Veränderungen erfordert: weniger arbeiten, anders arbeiten, Aufgaben abgeben, Karriereambitionen justieren, Lebensentscheidungen treffen. Deine Rolle als Coach ist es, diese Fragen zu halten und den Klienten bei seinen eigenen Antworten zu begleiten.`,
          uebung: {
            titel: 'Werte-Zeit-Abgleich',
            anleitung: `Führe einen Werte-Zeit-Abgleich durch:

Schritt 1 — Meine Top-5-Werte (was mir wirklich wichtig ist):
1. ___
2. ___
3. ___
4. ___
...
Schritt 2 — Meine Zeitverteilung letzte Woche (Prozent der wachen Stunden):
Arbeit: ___%
Familie/Partnerschaft: ___%
Freunde/Soziales: ___%
Bewegung/Gesundheit: ___%
Erholung/Hobbys: ___%
Sonstiges: ___%

Schritt 3 — Vergleich:
Wo stimmen Werte und Zeitinvestition überein? ___
Wo klaffen sie auseinander? ___

Schritt 4 — Eine realistische Anpassung für nächste Woche:
___

Das Ziel ist nicht Perfektion — es ist bewusste Annäherung.`,
            dauer: '15 Min',
          },
        },
      ],
...
Morgens (10 Min):
Wähle: □ Vagusnerv-Übung (5 Min) + □ Kurz-Bewegung (5 Min)
Konkreter Ablauf: ___
...
□ Schlafoptimierung (Abendritual)
Meine Wahl: ___

Gesamtzeit: 35 Minuten pro Tag — verteilt, nicht am Stück.

Teste diese Routine eine Woche lang und bewerte:
Schlafqualität: vorher ___/10 → nachher ___/10
Stresslevel: vorher ___/10 → nachher ___/10
Energie: vorher ___/10 → nachher ___/10`,
...
Welche Sätze höre ich innerlich, wenn ich unter Stress bin?
□ „Sei perfekt — kein Fehler erlaubt"
□ „Sei stark — zeig keine Schwäche"
□ „Mach es allen recht — enttäusche niemanden"
□ „Beeil dich — schneller, schneller"
□ „Streng dich an — es ist nie genug"

Mein stärkster Antreiber: ___

Wessen Stimme ist das ursprünglich? (Eltern, Lehrer, Chef, Gesellschaft) ___

Was kostet mich dieser Antreiber? (Energie, Gesundheit, Beziehungen) ___

Was wäre der Gegensatz — der Erlaubnissatz?
„Sei perfekt" → „Gut genug ist gut genug"
„Sei stark" → „___"
„Mach es allen recht" → „___"
„Beeil dich" → „___"
„Streng dich an" → „___"

Schreibe deinen Erlaubnissatz auf und lies ihn eine Woche lang täglich morgens — laut, vor dem Spiegel.`,
            dauer: '15 Min',
          },
        },
        {
          id: 'C09-M5-L3',
          titel: 'Stressmanagement als Unternehmenskultur',
          inhalt: `Individuelles Stressmanagement stößt an Grenzen, wenn die Unternehmenskultur Überarbeitung belohnt, Pausen als Schwäche wertet und Erreichbarkeit rund um die Uhr erwartet. Nachhaltiges Stressmanagement für Führungskräfte muss deshalb auch die systemische Ebene adressieren — die Führungskraft als Gestalterin einer gesünderen Arbeitskultur.
...
Deine Rolle als Coach geht über die Einzelarbeit hinaus: Du kannst Workshops für Führungsteams anbieten, Impulsvorträge halten, Team-Coaching-Formate entwickeln und Unternehmen bei der Gestaltung einer gesünderen Arbeitskultur beraten. Diese systemische Perspektive macht dein Angebot für Unternehmen wertvoller — und nachhaltiger.`,
          uebung: {
            titel: 'Kultur-Impuls planen',
            anleitung: `Plane einen konkreten Kultur-Impuls, den eine Führungskraft in ihrem Team umsetzen könnte:

Bereich: □ Meeting-Kultur □ Erreichbarkeits-Regeln □ Pausen-Kultur □ Feedback-Kultur

Konkreter Impuls:
Was wird verändert? ___
Ab wann? ___
Wie wird es kommuniziert? ___
Wie geht die Führungskraft mit Vorbild voran? ___
...
Diesen Impuls kannst du als Coaching-Ergebnis mit deiner Führungskraft gemeinsam entwickeln und begleiten.`,
            dauer: '10 Min',
          },
        },
      ],
...
Meine drei Zugangswege zum Markt:
1. ___
2. ___
3. ___

Mein Elevator Pitch (3 Sätze — was ich sage, wenn eine Führungskraft mich fragt, was ich mache):
___`,
            dauer: '15 Min',
          },
        },
...
Die persönliche Weiterentwicklung: Bilde dich weiter — in Coaching-Methoden, in Stressforschung, in angrenzenden Bereichen. Besuche Retreats, nicht nur als Anbieter, sondern als Teilnehmer. Lies, reflektiere, wachse. Die beste Investition in dein Business ist die Investition in dich selbst.`,
          uebung: {
            titel: 'Coach-Selbstfürsorge-Audit',
            anleitung: `Bewerte dein eigenes Stressmanagement als Coach:

Eigene Praxis:
Meditiere ich regelmäßig? ___
Bewege ich mich ausreichend? ___
Schlafe ich mindestens 7 Stunden? ___
Esse ich bewusst? ___

Grenzen:
Wie viele Sitzungen pro Tag maximal? ___
Habe ich feste Feierabendzeiten? ___
Ist mein Wochenende frei? ___

Unterstützung:
Habe ich Supervision? ___
Habe ich einen eigenen Coach/Therapeuten? ___
Habe ich Vertrauenspersonen, mit denen ich offen reden kann? ___

Erholung:
Wann war mein letzter Urlaub ohne Arbeit? ___
Was nährt mich außerhalb der Arbeit? ___

Bewertung: Auf einer Skala von 1–10 — wie gut sorge ich für mich? ___
Was ist der eine Punkt, den ich ab morgen verbessere? ___`,
            dauer: '10 Min',
          },
        },
        {
...
2. Welches Werkzeug hat dich am meisten überzeugt? ___

3. Was hast du an deinem eigenen Stressmanagement verändert? ___

4. Für welche Art von Führungskraft siehst du dich als idealen Coach? ___

5. Was ist dein Commitment?
