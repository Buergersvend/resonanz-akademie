const Y02 = {
  ...
  module: [
    {
      id: 'Y02-M1',
      titel: 'Die Schaltkreise der Körpergrafik',
      lektionen: [
        {
          id: 'Y02-M1-L1',
          titel: 'Individuelle, kollektive und Stammes-Schaltkreise',
          inhalt: `Die vierundsechzig Tore und sechsunddreißig Kanäle der Körpergrafik sind nicht isoliert — sie sind in drei große Schaltkreisgruppen organisiert, die fundamental unterschiedliche Lebensthemen tragen. Das Verständnis dieser Schaltkreise verwandelt deine Chartanalyse von einer Aufzählung einzelner Definitionen zu einem lebendigen Gesamtbild.

Der individuelle Schaltkreis umfasst den Wissensschaltkreis und den Zentrierungsschaltkreis. Seine Energie ist mutativ, eigenwillig und auf persönliche Transformation ausgerichtet. Menschen mit starker individueller Definition tanzen zu ihrer eigenen Melodie — sie bringen Neues in die Welt, sind aber nicht primär darauf ausgerichtet, es zu teilen. Ihre Kraft liegt in der Einzigartigkeit, ihre Herausforderung in der Einsamkeit. Der individuelle Puls ist akustisch — diese Menschen wirken durch die Kraft ihrer Stimme und ihres kreativen Ausdrucks.

Der kollektive Schaltkreis teilt sich in den logischen und den abstrakten Schaltkreis. Der logische Schaltkreis sucht Muster, die in die Zukunft projiziert werden können — Formeln, Systeme, Vorhersagbarkeit. Der abstrakte Schaltkreis verarbeitet Erfahrungen der Vergangenheit — Geschichten, Erinnerungen, emotionale Zyklen. Gemeinsam ist beiden die Ausrichtung auf das Wohl der Gemeinschaft: Was nützt vielen? Was kann geteilt werden? Menschen mit starker kollektiver Definition sind natürliche Lehrer, Forscher oder Geschichtenerzähler.

Der Stammes-Schaltkreis ist die älteste und körperlichste Schaltkreisgruppe. Er regiert Themen wie Familie, Loyalität, Ressourcen, Sexualität, Territorium und materielle Sicherheit. Seine Sprache ist der Handschlag, der Vertrag, die Umarmung — physische Verbindung und gegenseitige Verpflichtung. Menschen mit starker Stammesdefinition bauen natürlich Gemeinschaften auf, sorgen für ihre Nächsten und verstehen die Dynamik von Geben und Nehmen instinktiv.
...
Die Mischung der Schaltkreise in einem Chart erzeugt die individuelle Dynamik. Die meisten Menschen tragen Definitionen in verschiedenen Schaltkreisen — und erleben die Spannung zwischen diesen verschiedenen Antrieben. Der Mensch, der gleichzeitig seinen eigenen Weg gehen will (individuell) und sich nach Zugehörigkeit sehnt (Stamm), kennt diesen inneren Konflikt. Die Kunst der vertieften Selbstbetrachtung ist es, diese Spannung zu benennen und als kreatives Potenzial zu rahmen.`
        ...
        {
          id: 'Y02-M1-L2',
          titel: 'Kanäle als Lebensthemen verstehen',
          inhalt: `Kanäle sind die Verbindungen zwischen zwei Zentren, gebildet durch zwei komplementäre Tore. Wo ein Tor ein Potenzial darstellt, ist ein Kanal eine fixierte Lebenskraft — eine Energie, die immer fließt und das Leben dieses Menschen durchzieht wie ein roter Faden.

Jeder der sechsunddreißig Kanäle hat ein übergeordnetes Thema, das sich aus der Kombination seiner beiden Tore ergibt. Der Kanal 34-57 verbindet die Sakralkraft des Generators mit der intuitiven Klarheit des Milzzentrums — das Ergebnis ist menschliche Archetype des Überlebenskünstlers, der intuitiv weiß, was zu tun ist, und die Kraft hat, es umzusetzen. Der Kanal 39-55 verbindet emotionale Provokation mit der Tiefe des Geistes — hier lebt die Kraft der Leidenschaft, die durch Provokation Tiefe erzeugt.
...
Für dein eigenes Verstehen hilft es, die technische Kanalinformation in erlebbare Sprache zu übersetzen: „Dieser Kanal ist wie ein Fluss, der ständig durch dich hindurchfließt — seine Kraft ist immer da, ob du sie nutzt oder nicht. Die Frage ist nicht, ob du diese Energie hast, sondern wie bewusst du sie lenkst." Diese metaphorische Ebene macht die abstrakte Chartinformation greifbar und alltagsrelevant.`
        ...
        {
          id: 'Y02-M1-L3',
          titel: 'Die Bedeutung der Torlinien',
          inhalt: `Jedes der vierundsechzig Tore hat sechs Linien, die das Torethema in sechs verschiedenen Variationen ausdrücken. Die Linie, in der ein Tor aktiviert ist, verändert seine Bedeutung erheblich — wie derselbe Akkord in verschiedenen Tonarten eine andere Stimmung erzeugt.

Die sechs Linien folgen einem universellen Entwicklungsmodell, das auch die Grundlage der Profile bildet. Die erste Linie ist der Forscher — sie sucht den sicheren Boden, das fundierte Verständnis. In jedem Tor drückt die erste Linie das Bedürfnis aus, das Thema von Grund auf zu verstehen. Die zweite Linie ist das Naturtalent — sie beherrscht das Thema intuitiv, ohne es studiert zu haben. In jedem Tor zeigt die zweite Linie die natürliche Begabung, die keiner Erklärung bedarf.

Die dritte Linie ist der Experimentator — sie lernt durch Versuch und Irrtum, durch Erfahrung und Anpassung. In jedem Tor bringt die dritte Linie die praktische, manchmal chaotische Dimension ein. Die vierte Linie ist der Netzwerker — sie verbreitet das Thema durch Beziehungen und persönlichen Einfluss. In jedem Tor zeigt die vierte Linie die soziale Dimension, die Weitergabe durch Verbindung.

Die fünfte Linie ist der Universalisierer — sie wird von anderen als Problemlöser projiziert und kann das Thema auf eine allgemeingültige Ebene heben. In jedem Tor trägt die fünfte Linie das Potenzial der Projektion: Andere erwarten Lösungen, die der Träger möglicherweise nicht liefern kann. Die sechste Linie ist das Vorbild — sie durchläuft drei Lebensphasen: Experimentieren bis etwa dreißig, Rückzug und Reflexion bis etwa fünfzig, dann Vorbildfunktion und Weisheit. In jedem Tor zeigt die sechste Linie den Weg vom Erleben über das Verstehen zum verkörperten Vorbild.
...
Für die fortgeschrittene Analyse beachtest du auch die Farbverschiebung der Linien: Jede Linie hat eine obere und untere Ausprägung, die mit der Farbe — einer noch tieferen Schicht des Charts — zusammenhängt. Diese Ebene geht über die Grundlagen hinaus, ist aber ein Hinweis auf die Tiefe, die das Human Design bietet. In der praktischen Selbstbetrachtung arbeitest du mit den sechs Linien als Hauptunterscheidung — die tieferen Schichten bleiben als Raum für spätere Vertiefung.`
    ...
    {
      id: 'Y02-M2',
      titel: 'Variablen und die tieferen Ebenen',
      lektionen: [
        {
          id: 'Y02-M2-L1',
          titel: 'Die vier Variablen — Einführung',
          inhalt: `Die vier Variablen sind die tiefste mechanische Ebene des Human Design Charts. Sie beschreiben, wie ein Mensch optimal Nahrung aufnimmt, wie seine Umgebung sein Wohlbefinden beeinflusst, wie er am besten Informationen verarbeitet und welche Perspektive er in die Welt bringt. Diese Ebene wird oft als fortgeschrittenes Wissen betrachtet — sie ist jedoch von unmittelbarer praktischer Relevanz für jeden Menschen.

Die Variablen werden aus den Pfeilen abgelesen, die am Kopf der Körpergrafik erscheinen — vier Pfeile, die jeweils nach links oder rechts zeigen. Links steht für eine strategische, fokussierte, aktive Qualität. Rechts steht für eine rezeptive, periphere, passive Qualität. Die Kombination der vier Pfeilrichtungen ergibt sechzehn mögliche Variable-Typen, jeder mit spezifischen Empfehlungen für Ernährung, Umgebung, Motivation und Bewusstseinsperspektive.
...
Für den Einstieg sind Ernährung und Umgebung die zugänglichsten Variablen. Beginne dort in deinem eigenen Experiment — die Ergebnisse sind oft unmittelbar spürbar und schaffen Vertrauen für die tieferen Ebenen.`
        ...
        {
          id: 'Y02-M2-L2',
          titel: 'Determination — Die sechs Ernährungstypen',
          inhalt: `Die Ernährungsvariable, auch Determination genannt, differenziert sich in sechs Typen, die jeweils in einer linken und einer rechten Ausprägung existieren. Diese zwölf Varianten beschreiben nicht Ernährungsinhalte, sondern die optimalen Bedingungen der Nahrungsaufnahme — ein revolutionärer Ansatz, der die individuelle Körperintelligenz über allgemeine Ernährungsregeln stellt.

Der erste Typ ist die Appetit-Determination. In der linken Ausprägung folgt dieser Mensch seinem bewussten Appetit — er weiß, worauf er Lust hat, und sollte dieser Lust folgen. In der rechten Ausprägung reagiert der Körper auf äußere Stimulation — ein bestimmter Geruch, ein Bild, ein Marktbesuch löst den richtigen Appetit aus. Der Schlüssel: Nicht der Kopf entscheidet, was gegessen wird, sondern der Körper — über Appetit oder sensorische Resonanz.

Der zweite Typ ist die Geschmacks-Determination. Links bedeutet: Fokus auf einen dominanten Geschmack pro Mahlzeit — nicht fünf Gänge mit verschiedenen Aromen, sondern Klarheit im Geschmacksprofil. Rechts bedeutet: Das Mischen und Kombinieren verschiedener Geschmäcker nährt diesen Körper optimal — je vielfältiger, desto besser.

Der dritte Typ ist die Durst-Determination. Hier geht es um die Rolle von Flüssigkeit bei der Nahrungsaufnahme. Links: Trinken und Essen sind getrennte Ereignisse — kein Trinken während der Mahlzeit. Rechts: Flüssigkeit ist integraler Teil der Nahrung — Suppen, Eintöpfe, Smoothies und das Trinken während des Essens unterstützen die Verdauung.

Der vierte Typ ist die Berührungs-Determination. Links: Das haptische Erleben der Nahrung ist wichtig — die Textur, die Konsistenz, das Kauen. Kräftige, feste Nahrung, die dem Kiefer Arbeit gibt. Rechts: Weiche, leicht aufnehmbare Nahrung — püriert, gekocht, zart — wird besser verwertet.

Der fünfte Typ ist die Klang-Determination. Links: Stille beim Essen — keine Gespräche, keine Musik, keine Ablenkung. Der Fokus liegt vollständig auf der Nahrungsaufnahme. Rechts: Klangkulisse beim Essen — Musik, Gespräche, Hintergrundgeräusche unterstützen paradoxerweise die Verdauung.
...
Nimm die Ernährungsvariable als Experiment: Probiere für zwei Wochen aus, unter diesen Bedingungen zu essen, und beobachte, wie sich deine Verdauung und dein Energielevel verändern. Die körperliche Rückmeldung ist der beste Kompass. Bei körperlichen oder gesundheitlichen Beschwerden gehört die Abklärung zu Arzt, Heilpraktiker oder Therapeut.`
        ...
        {
          id: 'Y02-M2-L3',
          titel: 'Environment — Die sechs Umgebungstypen',
          inhalt: `Die Umgebungsvariable beschreibt, welche Art von physischem Raum das Nervensystem eines Menschen optimal unterstützt. Während die Ernährungsvariable den Körper nährt, nährt die richtige Umgebung das gesamte Energiefeld. Menschen, die ihre Umgebungsvariable kennen und umsetzen, berichten von tiefgreifenden Veränderungen in Wohlbefinden, Produktivität und innerer Ruhe.

Der erste Umgebungstyp sind Höhlen — geschlossene, geschützte Räume mit klarer Begrenzung. In der linken Ausprägung wählt dieser Mensch bewusst seinen Rückzugsort — ein eigenes Zimmer, ein Büro mit geschlossener Tür, ein klar abgegrenzter Bereich. Rechts wird die Höhle unbewusst gesucht — dieser Mensch findet sich instinktiv in Ecken, Nischen und geschützten Plätzen wieder. Beide brauchen den Schutz der Begrenzung, um sich sicher genug zu fühlen, sich zu öffnen.

Der zweite Umgebungstyp sind Märkte — belebte, vielfältige Orte mit vielen Reizen und Menschen. Links wählt dieser Mensch bewusst den Trubel — Cafés, Coworking-Spaces, belebte Innenstädte. Rechts wird er vom Marktgeschehen angezogen, ohne es bewusst zu suchen — er blüht auf in der Vielfalt, auch wenn er denkt, er bräuchte Ruhe. Die Marktenergie nährt sein System durch die Vielfalt der Eindrücke.

Der dritte Umgebungstyp sind Küchen — Orte der Transformation und Verarbeitung. Nicht buchstäblich nur die Küche, sondern jeder Ort, an dem etwas verwandelt wird — Werkstätten, Labore, Studios, Ateliers. Links sucht dieser Mensch aktiv den transformativen Ort. Rechts wird er von solchen Orten angezogen und findet sich dort am wohlsten, oft ohne zu verstehen, warum.

Der vierte Umgebungstyp sind Täler — geschützte Orte zwischen Erhebungen, mit natürlicher Begrenzung durch Landschaft. Metaphorisch: Orte, die eingebettet sind, die einen Rahmen haben, die nicht exponiert sind. Links wählt dieser Mensch bewusst den geschützten Talgrund. Rechts findet er sich in Talsituationen wieder und fühlt sich dort getragen.

Der fünfte Umgebungstyp sind Berge — erhöhte Positionen mit weitem Blick und Überblick. Metaphorisch: Orte, die Perspektive bieten — hohe Stockwerke, Hügel, Aussichtspunkte. Links sucht dieser Mensch aktiv die Höhe und den Überblick. Rechts wird er in erhöhte Positionen gebracht — beruflich, sozial, räumlich — und funktioniert dort am besten.

Der sechste Umgebungstyp sind Ufer — die Grenze zwischen zwei Welten, Land und Wasser, Stadt und Land, Innen und Außen. Küsten, Flussufer, Waldränder, Grenzgebiete. Links wählt dieser Mensch bewusst den Übergangsort. Rechts findet er sich an Grenzen wieder und entfaltet dort seine beste Wirkung. Die Ufermenschen sind natürliche Vermittler zwischen verschiedenen Welten.`
        }
      ]
    },
    {
      id: 'Y02-M3',
      titel: 'Transite und Zyklen',
      lektionen: [
        {
          id: 'Y02-M3-L1',
          titel: 'Das Transitfeld — Die kosmische Wetterlage',
          inhalt: `Das Transitfeld ist die aktuelle energetische Konfiguration, die durch die Positionen der Himmelskörper bestimmt wird und alle Menschen gleichzeitig beeinflusst. Es ist das kosmische Wetter — die Hintergrundenergie, in der wir alle leben, die aber jeden individuell anders trifft, abhängig von der eigenen Körpergrafik.

Die Sonne durchläuft in einem Jahr alle vierundsechzig Tore — jedes Tor wird etwa fünfeinhalb Tage lang aktiviert. Dies ist der dominanteste Transiteinfluss, da die Sonne siebzig Prozent der Neutrino-Masse ausmacht, die nach der Human Design Theorie die Prägung transportiert. Wenn die Sonne ein Tor aktiviert, das in deiner Körpergrafik ein hängendes Tor vervollständigt, entsteht vorübergehend ein neuer Kanal — eine Energie, die du normalerweise nicht hast, für wenige Tage aber erlebst.
...
Nutze die Lebenszyklen als Orientierungshilfe für dich selbst: „Ich bin in meinem Saturn-Return — das ist eine natürliche Zeit der Neuausrichtung. Was ich jetzt als Krise erlebe, ist die Einladung, mein eigenes Leben zu wählen." Diese Rahmung verwandelt Unsicherheit in Verständnis und gibt dir die Erlaubnis, dich zu verändern.`
        ...
        {
          id: 'Y02-M3-L3',
          titel: 'Das Inkarnationskreuz vertiefen',
          inhalt: `Das Inkarnationskreuz ist die übergeordnete Lebensrichtung eines Menschen — es beschreibt nicht, was er tut, sondern wozu er hier ist. Es wird gebildet durch die vier Torpositionen von Sonne und Erde in der bewussten und der unbewussten Berechnung und trägt das Lebensthema, das sich wie ein roter Faden durch alle Erfahrungen zieht.

Es gibt hundertzweiundneunzig grundlegende Inkarnationskreuze, die sich in drei Kategorien aufteilen: Rechte-Winkel-Kreuze — die persönliche Bestimmung. Diese Menschen folgen einem eigenen Lebensweg, der nicht primär von anderen abhängt. Ihre Aufgabe entfaltet sich durch das Leben selbst, durch die eigene Erfahrung und Entwicklung. Etwa zweiundsechzig Prozent aller Menschen tragen ein Rechtes-Winkel-Kreuz.

Juxtapositions-Kreuze — die fixierte Bestimmung. Diese Menschen haben einen sehr spezifischen, schmalen Lebensweg, der wenig Spielraum für Abweichung lässt. Sie sind auf eine bestimmte Aufgabe ausgerichtet wie ein Laser — mit enormer Durchschlagskraft, aber wenig Flexibilität. Etwa zwei Prozent tragen ein Juxtapositions-Kreuz.

Linkes-Winkel-Kreuze — die transpersonale Bestimmung. Diese Menschen entfalten ihre Lebensaufgabe durch und mit anderen. Ihr Kreuz verwirklicht sich in Beziehungen, Gemeinschaften und kollektiven Projekten. Etwa sechsunddreißig Prozent tragen ein Linkes-Winkel-Kreuz.

Die Vertiefung der Kreuzanalyse geht über die Namensbezeichnung hinaus. Du betrachtest die vier Tore des Kreuzes einzeln und in ihrer Wechselwirkung. Welches Tor liegt in der bewussten Sonne — dem dominantesten Persönlichkeitsaspekt? Welches in der unbewussten Sonne — dem verborgensten, aber kraftvollsten Antrieb? Welche Tore bilden die Erdachse — die Erdung und das Fundament des Lebensthemas?
...
Betrachte das Inkarnationskreuz nicht als starre Bestimmung, sondern als Lebensthema, das sich organisch entfaltet. „Dein Kreuz zeigt nicht, was du tun sollst — es zeigt, welches Thema sich durch alles zieht, was du tust. Ob du Bäcker bist oder Künstler — dieses Thema färbt deine Arbeit, deine Beziehungen und deine Entwicklung." Diese Rahmung gibt Orientierung, ohne einzuengen.`
    ...
    {
      id: 'Y02-M4',
      titel: 'Fortgeschrittene Zentrenanalyse',
      lektionen: [
        {
          id: 'Y02-M4-L1',
...
Das offene Ajna-Zentrum übernimmt die Konzepte und Überzeugungen anderer und hält sie vorübergehend für die eigenen. Die Konditionierung zeigt sich als Unsicherheit in den eigenen Meinungen und als Tendenz, sich von überzeugend auftretenden Menschen beeinflussen zu lassen. Die Weisheit liegt in der intellektuellen Offenheit — der Fähigkeit, verschiedene Perspektiven einzunehmen, ohne an einer festzuhalten. Ein weises offenes Ajna erkennt: „Ich muss nicht sicher sein. Ich darf offen bleiben."

Das offene Kehlzentrum — das Zentrum der Manifestation und Kommunikation — wird konditioniert, wenn es versucht, ständig Aufmerksamkeit durch Reden oder Handeln zu erzeugen. Die Weisheit liegt im Wissen, wann Sprechen wirkungslos und wann es kraftvoll ist. Ein Mensch mit offenem Kehlzentrum, der seine Weisheit lebt, spricht nur, wenn er eingeladen wird — und seine Worte haben dann besonderes Gewicht.
...
Arbeite mit der Doppelnatur jedes offenen Zentrums: „Hier liegt deine größte Verwundbarkeit und dein größtes Weisheitspotenzial am selben Ort. Die Konditionierung ist der Rohstoff, aus dem durch Bewusstheit Weisheit entsteht." Diese Perspektive verwandelt die Wahrnehmung offener Zentren von einem Defizit in ein Geschenk und gibt dem Dekonditionierungsprozess eine positive Richtung.`
        ...
        {
          id: 'Y02-M4-L2',
          titel: 'Splits und Definition — Die innere Dynamik',
          inhalt: `Die Art, wie die definierten Zentren in einem Chart miteinander verbunden oder voneinander getrennt sind, erzeugt grundlegend verschiedene innere Dynamiken. Die Split-Analyse ist eines der mächtigsten Werkzeuge der fortgeschrittenen Chartanalyse und erklärt viele Beziehungsmuster, die auf der Typen- und Profilebene unsichtbar bleiben.

Einzelne Definition bedeutet, dass alle definierten Zentren durch Kanäle miteinander verbunden sind — die Energie fließt in einem zusammenhängenden Kreislauf. Diese Menschen haben eine innere Geschlossenheit und Selbstgenügsamkeit. Sie brauchen andere nicht zur Vervollständigung und können Entscheidungen zügig treffen. Etwa einundvierzig Prozent der Menschen haben eine Einzeldefinition.

Split-Definition bedeutet, dass zwei Gruppen definierter Zentren existieren, die nicht direkt miteinander verbunden sind — eine Brücke fehlt. Diese Menschen erleben zwei verschiedene innere Stimmen oder Energieströme, die nicht automatisch miteinander kommunizieren. Sie werden magnetisch von Menschen angezogen, die den fehlenden Kanal mitbringen und damit die Brücke bilden. In Beziehungen kann das zu einer tiefen Verbindung führen — aber auch zu Abhängigkeit. Etwa fünfundvierzig Prozent haben eine Split-Definition.

Dreifach-Split-Definition hat drei voneinander getrennte Definitionsgruppen. Diese Menschen brauchen verschiedene Kontakte, um alle Teile ihrer Definition zu verbinden — kein einzelner Mensch kann das leisten. Sie fühlen sich in Gruppen wohler als in Zweierbeziehungen und brauchen soziale Vielfalt. Etwa elf Prozent haben eine Dreifach-Split-Definition.
...
Die elektromagnetische Anziehung ist der stärkste Beziehungsmagnet im Human Design. Wenn zwei Menschen zusammen einen Kanal vervollständigen, den keiner allein hat, erleben beide die Energie dieses Kanals nur in Gegenwart des anderen. Das kann sich anfühlen wie Heimkommen, wie Vervollständigung, wie ein fehlendes Puzzleteil. Die Herausforderung: Diese Energie ist abhängig von der Anwesenheit des anderen. In gesunden Beziehungen wird sie genossen, ohne zur Abhängigkeit zu werden. In ungesunden Beziehungen wird sie zum Gefängnis.

Die Dominanz-Dynamik zeigt, wer wen in welchen Bereichen konditioniert. Wenn ein Partner ein Zentrum definiert hat und der andere es offen hat, fließt die Konditionierungsenergie vom Definierten zum Offenen. Der Partner mit dem definierten Emotionalzentrum bestimmt die emotionale Atmosphäre. Der Partner mit dem definierten Sakralzentrum bestimmt das Arbeitstempo. Das ist weder gut noch schlecht — aber Bewusstheit darüber verhindert Schuldzuweisungen und fördert Verständnis.
