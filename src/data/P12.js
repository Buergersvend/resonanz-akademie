...
Selbstwahrnehmung (1–10):
Kann ich meine Emotionen in dem Moment benennen, in dem sie auftreten? ___

Selbstregulation (1–10):
Kann ich meine Impulse steuern und wählen, wie ich auf Emotionen reagiere? ___

Motivation (1–10):
Kann ich mich selbst motivieren und bei Rückschlägen weitermachen? ___

Empathie (1–10):
Kann ich die Gefühle anderer wahrnehmen und nachempfinden? ___

Soziale Kompetenz (1–10):
Kann ich Beziehungen bewusst gestalten und Konflikte konstruktiv lösen? ___

Gesamt: ___/50

Deine stärkste Kompetenz: ___
Deine schwächste Kompetenz: ___

Diese Kompetenz wird dein Hauptfokus in diesem Kurs. Bewahre die Einschätzung auf — du wiederholst sie am Ende des Kurses.`,
            dauer: '10 Min',
          },
        },
        {
          id: 'P12-M1-L2',
          titel: 'Die Neurobiologie der Emotionen',
          inhalt: `Emotionen sind keine abstrakten psychologischen Phänomene — sie sind konkrete neurobiologische Ereignisse mit messbaren Veränderungen im Gehirn, im Nervensystem und im gesamten Körper. Das Verständnis dieser Biologie gibt dir einen nüchternen, respektvollen Blick auf Emotionen und erklärt, warum reine Willenskraft oft nicht ausreicht, um emotionale Muster zu verändern.
...
Analysiere den Hijack:

1. Was war der Auslöser? (Wort, Situation, Person, Erinnerung)

2. Was war die körperliche Reaktion? (Herzrasen, Hitze, Enge, Zittern)

3. Wie schnell kam die Reaktion? (Sofort? Millisekunden?)

4. Was hast du gesagt oder getan — in den ersten Sekunden?

5. Wann hat der rationale Verstand „aufgeholt"? (Sekunden? Minuten? Stunden?)

6. Was hättest du getan, wenn du drei Sekunden Pause gehabt hättest?

Diese drei Sekunden — der Raum zwischen Reiz und Reaktion — sind das Ziel des EQ-Trainings. Nicht die Emotion verhindern, sondern den Raum der Wahl vergrößern.`,
            dauer: '10 Min',
          },
        },
        {
...
Für jede Basisemotion — finde mindestens fünf spezifischere Varianten:

Freude: Begeisterung, ___, ___, ___, ___
Trauer: Wehmut, ___, ___, ___, ___
Wut: Frustration, ___, ___, ___, ___
Angst: Sorge, ___, ___, ___, ___
Scham: Verlegenheit, ___, ___, ___, ___

Tipp: Denke an Intensität (leicht → stark), Anlass (beruflich, persönlich, existenziell) und Qualität (scharf, dumpf, heiß, kalt).

Praxis: Setze dir heute dreimal einen Alarm. Bei jedem Alarm: Benenne dein aktuelles Gefühl — so spezifisch wie möglich. Nicht „okay", nicht „gut" — sondern das präzise Wort.

Je feiner dein emotionales Vokabular, desto feiner deine emotionale Wahrnehmung — bei dir selbst und bei deinen Klienten.`,
            dauer: '10 Min',
          },
        },
      ],
    },
    {
      ...
      lektionen: [
        {
          id: 'P12-M2-L1',
          titel: 'Emotionen in Echtzeit erkennen',
          inhalt: `Selbstwahrnehmung — die Fähigkeit, eigene Emotionen im Moment ihres Entstehens zu erkennen — ist die Grundlage aller anderen EQ-Kompetenzen. Du kannst eine Emotion nicht regulieren, die du nicht bemerkst. Du kannst nicht empathisch sein, wenn du deine eigenen Gefühle nicht von denen anderer unterscheiden kannst. Und du kannst keine bewussten Beziehungen führen, wenn du nicht weißt, was in dir vorgeht.

Die größte Hürde der Selbstwahrnehmung ist die Identifikation mit der Emotion. Wenn du wütend bist, bist du die Wut — sie füllt dein gesamtes Bewusstsein aus, und es gibt keinen Beobachter, der sie wahrnimmt. Erst wenn du einen inneren Schritt zurücktrittst und bemerkst „Ah, da ist Wut", ist die Selbstwahrnehmung aktiv. Dieser Schritt — vom Sein zum Bemerken — ist die fundamentale Fähigkeit, die du trainierst.

Der Körper ist dein zuverlässigster Emotionsmelder. Emotionen manifestieren sich körperlich, bevor sie bewusst werden: Angst zeigt sich als Enge in der Brust, Wut als Hitze im Gesicht, Trauer als Schwere in den Schultern, Scham als Ziehen im Bauch, Freude als Weite und Leichtigkeit. Wenn du lernst, diese körperlichen Signale in Echtzeit wahrzunehmen, erkennst du die Emotion, bevor sie dein Verhalten übernimmt.

Die Technik des Body-Scan-Moment: Mehrmals täglich — idealerweise verbunden mit einem Alltagstrigger wie dem Öffnen einer Tür, dem Klingeln des Telefons oder dem Aufstehen vom Stuhl — hältst du einen Moment inne und scannst deinen Körper: Was spüre ich gerade? Wo ist Spannung? Wo ist Leichtigkeit? Was ist die emotionale Tönung? Du brauchst dafür keine Meditation, keinen ruhigen Raum und keine besondere Vorbereitung — nur den Moment der Aufmerksamkeit.

Die Praxis des emotionalen Journaling vertieft die Selbstwahrnehmung über die Zeit. Abends nimmst du dir fünf Minuten und schreibst die drei stärksten emotionalen Momente des Tages auf: Was war der Auslöser? Was habe ich gefühlt? Wo habe ich es im Körper gespürt? Wie habe ich reagiert? Nach zwei Wochen zeigen sich Muster — wiederkehrende Trigger, typische Reaktionen, blinde Flecken. Diese Muster sind Gold wert für die Selbstentwicklung.`,
          uebung: {
            titel: 'Emotionales Echtzeit-Protokoll',
            anleitung: `Führe heute ein Echtzeit-Emotions-Protokoll:

Setze dir fünf Alarme über den Tag verteilt. Bei jedem Alarm notiere sofort — innerhalb von dreißig Sekunden:

Zeit: ___
Situation: Was mache ich gerade? ___
Körper: Was spüre ich physisch? ___
Emotion: Welches Gefühl ist da? (So spezifisch wie möglich) ___
Intensität: 1–10 ___
Gedanke: Welcher Gedanke begleitet das Gefühl? ___

Am Abend: Lies alle fünf Einträge. Was fällt dir auf?
- Wie oft warst du dir deiner Emotion bereits bewusst, bevor der Alarm kam?
- Gab es Überraschungen — Emotionen, die du nicht erwartet hättest?
- Gibt es einen Zusammenhang zwischen Situation und Emotion?

Wiederhole drei Tage lang. Die Muster, die sich zeigen, sind dein Entwicklungskompass.`,
            dauer: '1 Min pro Alarm, 10 Min Abendreflexion',
          },
        },
        {
          id: 'P12-M2-L2',
          titel: 'Emotionale Muster und Trigger erkennen',
          inhalt: `Hinter den einzelnen Emotionen, die du im Alltag erlebst, liegen Muster — wiederkehrende emotionale Reaktionen auf bestimmte Trigger, die sich über Jahre und Jahrzehnte eingeprägt haben. Diese Muster sind nicht zufällig — sie wurden in der Kindheit geformt, durch Erfahrungen bestätigt und durch Wiederholung automatisiert. Sie steuern einen Großteil deines emotionalen Erlebens, ohne dass du es bemerkst.

Ein emotionaler Trigger ist ein Reiz — eine Situation, ein Wort, ein Tonfall, eine Person —, der eine überproportionale emotionale Reaktion auslöst. Du reagierst nicht auf das, was gerade geschieht, sondern auf das, was der Trigger in deiner Geschichte repräsentiert. Der Kollege, der dich ignoriert, triggert nicht die Reaktion auf sein aktuelles Verhalten — er triggert die Erfahrung des Nicht-Gesehen-Werdens in der Kindheit. Die Kritik des Partners triggert nicht die konkrete Aussage — sie triggert den Glaubenssatz „Ich bin nicht gut genug."

Die Erkennung deiner persönlichen Trigger ist ein Akt der Selbsterkenntnis, der dein gesamtes emotionales Erleben verändert. Typische Trigger-Kategorien: Zurückweisung triggert den Schmerz des Nicht-Dazugehörens. Kontrollverlust triggert die Angst des Ausgeliefertseins. Ungerechtigkeit triggert die Wut des Machtlosen. Kritik triggert die Scham des Nicht-Genügens. Vernachlässigung triggert die Trauer des Verlassenseins.

Die Methode der Überreaktion-Analyse: Jedes Mal, wenn du überreagierst — die Emotion ist stärker als die Situation rechtfertigt —, hast du einen Trigger identifiziert. Notiere die Situation, die Reaktion und dann die zentrale Frage: „Was erinnert mich diese Situation?" Nicht auf der inhaltlichen Ebene — sondern auf der Gefühlsebene. Welches alte Gefühl wurde aktiviert? In welcher Lebenssituation habe ich dieses Gefühl zum ersten Mal erlebt?

Das Trigger-Tagebuch über vier Wochen zeigt deine drei bis fünf Haupttrigger — die emotionalen Knöpfe, die die stärksten Reaktionen auslösen. Diese Haupttrigger sind deine wichtigsten Entwicklungsfelder: Nicht die Trigger zu vermeiden ist das Ziel, sondern die emotionale Ladung zu entschärfen, die sie tragen.`,
          uebung: {
            titel: 'Trigger-Analyse',
            anleitung: `Identifiziere deine drei stärksten emotionalen Trigger:

Denke an drei Situationen der letzten Monate, in denen du überproportional emotional reagiert hast:

Situation 1:
- Was ist passiert? ___
- Wie habe ich reagiert? ___
- Welches Gefühl war dominant? ___
- War die Reaktion angemessen zur Situation? (Ja/Nein)
- Was hat mich eigentlich getriggert — was liegt darunter? ___
- Wann habe ich dieses Gefühl zum ersten Mal in meinem Leben erlebt? ___

Situation 2: (gleiche Fragen)

Situation 3: (gleiche Fragen)

Gibt es ein gemeinsames Thema unter den drei Situationen? ___

Dieses Thema ist dein Kern-Trigger — der emotionale Knopf, an dem du arbeiten wirst.`,
            dauer: '15 Min',
          },
        },
        {
          id: 'P12-M2-L3',
          titel: 'Emotionale Selbstehrlichkeit',
          inhalt: `Emotionale Selbstehrlichkeit ist die fortgeschrittenste Form der Selbstwahrnehmung — die Bereitschaft, auch die Emotionen zu fühlen und anzuerkennen, die unbequem, sozial unerwünscht oder selbstbild-bedrohend sind. Neid, Eifersucht, Groll, Schadenfreude, Hilflosigkeit, Bedürftigkeit — all diese Gefühle gehören zum menschlichen Repertoire, und ihre Verleugnung kostet mehr Energie als ihre Anerkennung.
...
Vervollständige ehrlich und ohne Zensur:

„Ich gebe ungern zu, dass ich manchmal ___ fühle."

„Die Emotion, die ich am meisten unterdrücke, ist ___."

„Wenn ich ganz ehrlich bin, empfinde ich gegenüber [Person] manchmal ___."

„Das Gefühl, das am meisten meinem Selbstbild widerspricht, ist ___."

„Wenn ich alles fühlen dürfte, ohne bewertet zu werden, würde ich ___ fühlen."

Lies deine Antworten langsam noch einmal. Spüre in den Körper: Was passiert, wenn du diese Gefühle anerkennst? Anspannung? Erleichterung? Scham? Befreiung?

Die Anerkennung ist der erste Schritt. Nicht die Lösung — die Anerkennung. Denn was du nicht anerkennen kannst, kannst du nicht verändern.`,
            dauer: '15 Min',
          },
        },
      ],
...
Die Stopp-Technik bei eskalierenden Emotionen: Wenn du merkst, dass eine Emotion die Kontrolle übernimmt, sagst du innerlich — oder laut — „Stopp." Dann verlässt du die Situation physisch — für eine Minute, fünf Minuten, eine Stunde. Nicht als Flucht, sondern als bewusste Regulationsmaßnahme. Du kommst zurück, wenn der präfrontale Cortex wieder das Sagen hat. In Partnerschaften kann diese Technik als Vereinbarung etabliert werden: „Wenn einer von uns Stopp sagt, machen wir dreißig Minuten Pause — und kommen dann zurück."`,
          uebung: {
            titel: 'Regulations-Toolkit aufbauen',
            anleitung: `Erstelle dein persönliches Regulations-Toolkit — vier Techniken für verschiedene Intensitäten:

Stufe 1 — Leichte Irritation:
Meine Technik: ___ (z.B. dreimal tief ausatmen)
Wie lange: ___

Stufe 2 — Deutliche Emotion:
Meine Technik: ___ (z.B. Benennen + Reframing)
Wie lange: ___

Stufe 3 — Starke Emotion:
Meine Technik: ___ (z.B. Stopp + Situation verlassen)
Wie lange: ___

Stufe 4 — Überwältigende Emotion:
Meine Technik: ___ (z.B. 5-4-3-2-1 Erdung + kaltes Wasser)
Wie lange: ___

Schreibe das Toolkit auf eine Karte und trage sie eine Woche bei dir. Jedes Mal, wenn eine Emotion aufsteigt, wähle die passende Stufe und wende die Technik an. Dokumentiere: Was hat funktioniert? Was nicht?`,
            dauer: '10 Min',
          },
        },
        {
          ...
          inhalt: `Schwierige Emotionen — Wut, Angst, Scham, Trauer, Eifersucht, Hilflosigkeit — sind nicht das Gegenteil emotionaler Intelligenz. Sie sind ihr Testfeld. Jeder kann freundlich und gelassen sein, wenn alles gut läuft. Emotionale Intelligenz zeigt sich in den Momenten, in denen es schwierig wird — in den Momenten, in denen du am liebsten schreien, fliehen oder dich verkriechen würdest.

Wut konstruktiv nutzen: Wut ist Energie — konzentrierte, mobilisierende Kraft. Unkontrolliert zerstört sie Beziehungen. Kontrolliert und kanalisiert setzt sie Grenzen, schafft Veränderung und schützt Werte. Der Schlüssel: Die Wut fühlen, ohne von ihr übernommen zu werden. Drei Atemzüge nehmen. Dann die Frage: Was genau macht mich wütend? Welche Grenze wurde überschritten? Was brauche ich? Und dann: Die Grenze kommunizieren — klar, bestimmt, ohne Angriff. „Es ist nicht in Ordnung, wie du gerade mit mir gesprochen hast. Ich brauche Respekt in unserem Gespräch."
...
Trauer zulassen: Trauer ist der natürliche Verarbeitungsprozess für Verlust — und sie braucht Zeit, Raum und die Erlaubnis, da zu sein. Die Gesellschaft gibt Trauernden zunehmend weniger Raum — nach ein paar Wochen wird erwartet, dass man funktioniert. Emotionale Intelligenz bedeutet, der Trauer den Raum zu geben, den sie braucht — und anderen denselben Raum zu gewähren.`,
          uebung: {
            titel: 'Emotions-Transformation',
            anleitung: `Wähle eine schwierige Emotion, die aktuell in deinem Leben präsent ist.

Meine Emotion: ___

Schritt 1 — Fühlen: Schließe die Augen. Spüre die Emotion im Körper. Wo ist sie? Wie groß? Welche Temperatur? Welche Farbe? Welche Form? Bleibe 60 Sekunden dort.

Schritt 2 — Benennen: Benenne die Emotion so spezifisch wie möglich. Nicht „schlecht" — sondern ___

Schritt 3 — Verstehen: Was sagt mir diese Emotion? Welches Bedürfnis liegt darunter? Was brauche ich eigentlich? ___

Schritt 4 — Wählen: Wie möchte ich mit dieser Emotion umgehen — jetzt, in diesem Moment? ___

Schritt 5 — Handeln: Was ist ein konkreter Schritt, den ich jetzt tun kann? ___

Diese fünf Schritte — Fühlen, Benennen, Verstehen, Wählen, Handeln — sind das Kernprotokoll emotionaler Intelligenz.`,
            dauer: '10 Min',
          },
        },
        {
          id: 'P12-M3-L3',
          titel: 'Emotionale Resilienz aufbauen',
          inhalt: `Emotionale Resilienz ist die Fähigkeit, nach emotionalen Erschütterungen — Rückschlägen, Enttäuschungen, Verlusten, Krisen — zurückzukehren zu einem Zustand der Balance und Handlungsfähigkeit. Sie bedeutet nicht, keine Erschütterung zu empfinden — sie bedeutet, sich von ihr zu erholen und gestärkt daraus hervorzugehen.

Die Forschung identifiziert sieben Schutzfaktoren der emotionalen Resilienz: Emotionsregulation — die Fähigkeit, intensive Gefühle zu steuern. Impulskontrolle — der Widerstand gegen unüberlegte Reaktionen. Optimismus — die realistische Zuversicht, dass Herausforderungen bewältigbar sind. Kausalanalyse — die Fähigkeit, die wirklichen Ursachen einer Situation zu erkennen. Empathie — die Verbindung zu anderen Menschen. Selbstwirksamkeit — das Vertrauen in die eigene Handlungsfähigkeit. Und Reaching out — die Bereitschaft, neue Erfahrungen zu machen und Hilfe anzunehmen.
...
Emotionsregulation: ___/10
Impulskontrolle: ___/10
Optimismus: ___/10
Kausalanalyse: ___/10
Empathie: ___/10
Selbstwirksamkeit: ___/10
Reaching out: ___/10

Dein stärkster Faktor: ___
Dein schwächster Faktor: ___
...
Zusätzlich — starte die Drei-gute-Dinge-Praxis: Schreibe jeden Abend drei Dinge auf, die heute gut gelaufen sind und warum. Halte vier Wochen durch — viele Menschen erleben, dass diese einfache Übung die Zufriedenheit spürbar stärkt.`,
    ...
    },
    {
      ...
      lektionen: [
        {
          id: 'P12-M4-L1',
          titel: 'Die drei Arten der Empathie',
          inhalt: `Empathie — die Fähigkeit, die Gefühle anderer wahrzunehmen und nachzuempfinden — ist nicht eine einzelne Fähigkeit, sondern ein Bündel aus drei verschiedenen Kompetenzen, die jeweils eine eigene Funktion haben und unabhängig voneinander ausgeprägt sein können.

Kognitive Empathie — auch Perspektivübernahme genannt — ist die Fähigkeit, intellektuell zu verstehen, was ein anderer Mensch fühlt und denkt. Du kannst dich in seine Lage versetzen, seine Motive nachvollziehen und seine Reaktionen vorhersagen. Kognitive Empathie ist eine mentale Fähigkeit — du musst das Gefühl nicht selbst spüren, um es zu verstehen. Sie ist essenziell für Kommunikation, Verhandlung und Beratung. Ihre Schattenseite: Kognitive Empathie allein kann zur Manipulation genutzt werden — wer genau versteht, was andere fühlen, ohne selbst zu fühlen, kann diese Information ausnutzen.
...
Kognitive Empathie (1–10):
Kann ich nachvollziehen, warum jemand so denkt und fühlt, wie er es tut — auch wenn ich anderer Meinung bin? ___

Emotionale Empathie (1–10):
Fühle ich die Emotionen anderer im eigenen Körper — Freude, Trauer, Angst? ___

Empathische Fürsorge (1–10):
Werde ich durch das Mitfühlen zum Handeln motiviert — will ich helfen, unterstützen, begleiten? ___
...
Reflexion:
- Wenn kognitive Empathie am niedrigsten: Übe Perspektivwechsel — frage öfter „Wie ist das für den anderen?"
- Wenn emotionale Empathie am niedrigsten: Übe Präsenz — halte inne und spüre, wenn jemand erzählt.
- Wenn empathische Fürsorge am niedrigsten: Frage öfter „Was brauchst du gerade von mir?"`,
            dauer: '10 Min',
          },
        },
        {
          id: 'P12-M4-L2',
          titel: 'Empathie in der Praxis — Zuhören und Spiegeln',
          inhalt: `Empathie ist keine passive Eigenschaft — sie ist eine aktive Fähigkeit, die in der Interaktion geübt und verfeinert wird. Die beiden wichtigsten empathischen Werkzeuge sind das aktive Zuhören und das emotionale Spiegeln.

Aktives Zuhören geht weit über das Hören hinaus. Es bedeutet: volle Aufmerksamkeit auf den Sprechenden, ohne gleichzeitig die eigene Antwort zu formulieren. Es bedeutet: die Worte hören und das, was zwischen den Worten liegt — Tonfall, Pausen, Zögern, Widersprüche. Es bedeutet: den eigenen Impuls zu unterdrücken, sofort zu reagieren, zu bewerten, zu beraten oder die eigene Geschichte zu erzählen. Aktives Zuhören ist ein Geschenk — und eines der seltensten in unserer Gesellschaft.

Die Praxis des aktiven Zuhörens: Blickkontakt halten. Nicht unterbrechen. Kurze verbale Bestätigungen geben — „Mmh", „Ja", „Ich verstehe." Offene Fragen stellen, die zum Vertiefen einladen — „Wie hat sich das angefühlt?" statt „War das schlimm?" Zusammenfassen, was du gehört hast — „Wenn ich dich richtig verstehe, dann..." Diese Zusammenfassung zeigt dem Gegenüber, dass du wirklich zugehört hast — und gibt ihm die Möglichkeit, zu korrigieren, wenn du etwas falsch verstanden hast.

Emotionales Spiegeln geht einen Schritt tiefer: Du benennst die Emotion, die du beim anderen wahrnimmst — auch wenn er sie selbst nicht ausgesprochen hat. „Ich höre, dass dich das verletzt hat." „Es klingt, als wärst du enttäuscht." „Ich spüre, dass da Wut unter der Oberfläche ist." Dieses Spiegeln hat eine doppelte Wirkung: Es zeigt dem Gegenüber, dass er auf einer tiefen Ebene gesehen wird. Und es hilft ihm, seine eigene Emotion klarer zu erkennen — manchmal benennt das Spiegeln ein Gefühl, das dem Betroffenen selbst noch nicht bewusst war.

Die Kunst des Spiegelns: Nicht interpretieren, nicht diagnostizieren — nur wahrnehmen und anbieten. „Ich habe den Eindruck, dass..." oder „Es klingt so, als ob..." formulieren als Angebot, nicht als Feststellung. Und bereit sein, falsch zu liegen — das Gegenüber weiß besser als du, was es fühlt. Ein falsches Spiegeln — „Ich glaube, du bist wütend" — „Nein, ich bin traurig" — ist kein Fehler, es ist der Beginn eines vertieften Gesprächs.`,
          uebung: {
            titel: 'Zuhören und Spiegeln üben',
            anleitung: `Übe mit einem Übungspartner — fünfzehn Minuten:

Phase 1 — Zuhören (7 Min):
Der Partner erzählt frei über etwas, das ihn aktuell beschäftigt. Du hörst zu — nach den Regeln des aktiven Zuhörens:
□ Volle Aufmerksamkeit
□ Kein Unterbrechen
□ Keine eigene Geschichte
□ Kein Ratgeben
□ Kurze verbale Bestätigungen

Phase 2 — Spiegeln (3 Min):
Fasse zusammen, was du gehört hast — auf der Inhaltsebene und auf der Gefühlsebene:
„Du hast erzählt, dass... Und es klang so, als würdest du dich dabei ___ fühlen."

Phase 3 — Feedback (5 Min):
Der Partner gibt Feedback: Habe ich mich gehört gefühlt? War das Spiegeln treffend? Was hat besonders gut getan?
...
1. Was war die Situation? ___

2. Wie hat sich der empathische Stress angefühlt? (Körperlich, emotional) ___

3. War es Mitgefühl oder Mitleiden? Woran erkennst du den Unterschied? ___

4. Was hat dir gefehlt, um bei Mitgefühl zu bleiben? (Abgrenzung? Energie? Bewusstheit?) ___

5. Was hättest du anders machen können? ___

Praktische Übung — Metta-Meditation (5 Min):
Setze dich ruhig hin. Richte nacheinander liebevolle Gedanken auf:
- Dich selbst: „Möge ich glücklich sein. Möge ich gesund sein. Möge ich in Frieden leben."
- Eine geliebte Person: Gleiche Sätze.
- Eine neutrale Person: Gleiche Sätze.
- Eine schwierige Person: Gleiche Sätze.

Spüre den Unterschied zwischen Mitgefühl (warm, aktiv, verbunden) und Mitleiden (schwer, erschöpft, identifiziert).`,
            dauer: '15 Min',
          },
        },
      ],
    },
    {
      ...
      lektionen: [
        {
          id: 'P12-M5-L1',
          titel: 'Emotionale Kommunikation',
          inhalt: `Soziale Kompetenz — die fünfte Säule der emotionalen Intelligenz — ist die Fähigkeit, Beziehungen bewusst zu gestalten. Sie baut auf Selbstwahrnehmung, Selbstregulation, Motivation und Empathie auf und bringt sie in die Interaktion mit anderen. Der Kern sozialer Kompetenz ist die Fähigkeit zur emotionalen Kommunikation — Gefühle klar, ehrlich und respektvoll auszudrücken.
...
Emotionale Validierung — die Anerkennung der Gefühle des anderen, auch wenn du anderer Meinung bist — ist das machtvollste Kommunikationswerkzeug in Konflikten. „Ich verstehe, dass dich das verletzt hat" heißt nicht „Du hast Recht und ich Unrecht" — es heißt „Dein Gefühl ist real und berechtigt." Validierung deeskaliert Konflikte schneller als jedes Argument, weil sie das Grundbedürfnis des anderen — gesehen und anerkannt zu werden — befriedigt.`,
          uebung: {
            ...
            anleitung: `Wandle die folgenden Du-Botschaften in Ich-Botschaften um:

1. „Du hörst mir nie zu!"
→ „Ich fühle mich ___, wenn ___, weil ___."

2. „Du bist immer zu spät!"
→ ___

3. „Du denkst nur an dich!"
→ ___

4. „Du machst mich wahnsinnig!"
→ ___

5. „Du hast versprochen, das zu machen, und es nicht getan!"
→ ___

Prüfe jede Ich-Botschaft:
□ Enthält sie ein Gefühl? (Nicht „Ich fühle, dass du..." — das ist eine Du-Botschaft in Verkleidung)
□ Beschreibt sie das Verhalten ohne Bewertung?
□ Benennt sie das Bedürfnis dahinter?

Übe eine der Ich-Botschaften heute in einem realen Gespräch.`,
            dauer: '10 Min',
          },
        },
        {
...
1. Wenn es zum Konflikt kommt, tendiere ich eher zu:
□ Angriff (laut werden, beschuldigen)
□ Rückzug (schweigen, mauern, gehen)
...
4. Wie schnell repariere ich nach einem Konflikt? (Minuten / Stunden / Tage / Gar nicht)

5. Was wäre ein konkreter erster Schritt zu einem emotional intelligenteren Konfliktstil? ___

Teste diesen Schritt beim nächsten Konflikt — und beobachte, was sich verändert.`,
            dauer: '10 Min',
          },
        },
        {
...
1. Wenn drei Menschen, die mich gut kennen, meine emotionale Grundstimmung beschreiben würden — welche Worte würden sie wählen? ___

2. Welche emotionale Qualität bringe ich in meine Sitzungen? ___

3. Welche emotionale Qualität fehlt mir manchmal — und wäre hilfreich? ___

4. Was ist mein emotionaler „Anker" — der Zustand, zu dem ich zurückkehre, wenn es schwierig wird? ___

5. Wie pflege ich meine emotionale Grundstimmung? Was nährt sie? Was erschöpft sie? ___

Bitte diese Woche eine Vertrauensperson um ehrliches Feedback: „Wie wirke ich auf dich — emotional? Was strahlst du aus, wenn ich bei dir bin?" Die Antwort kann überraschen — und sie ist wertvoller als jede Selbsteinschätzung.`,
            dauer: '10 Min',
          },
        },
      ],
...
Sitzung 1 — Selbstwahrnehmung:
Was ist dein Ziel? ___
Welche Übung leitest du an? ___

Sitzung 2 — Trigger-Identifikation:
Was erforschst du mit ihm? ___
...
Welche Übung machst du? ___`,
            dauer: '15 Min',
          },
        },
        {
          id: 'P12-M6-L2',
          titel: 'EQ im Alltag — lebenslange Praxis',
          inhalt: `Emotionale Intelligenz ist keine Fähigkeit, die du einmal lernst und dann hast — sie ist eine lebenslange Praxis, die tägliche Aufmerksamkeit, Übung und Reflexion erfordert. Die gute Nachricht: Jede Begegnung, jedes Gespräch, jeder Konflikt und jede Emotion ist eine Übungsgelegenheit. Du brauchst kein separates Training — du brauchst nur Bewusstheit in dem, was du ohnehin tust.

Die Morgenminute für emotionale Klarheit: Bevor du in den Tag startest — eine Minute innerer Check. Wie fühle ich mich gerade? Was brauche ich heute? Welche Intention setze ich für meinen emotionalen Zustand? Diese Minute setzt den Ton für den ganzen Tag.

Die Mittags-Reflexion: In der Mitte des Tages — eine Minute Rückblick. Welche emotionalen Situationen gab es heute Vormittag? Wie habe ich reagiert? Gab es einen Moment, in dem ich emotional intelligenter hätte handeln können?

Die Abend-Bilanz: Die drei Fragen der emotionalen Hygiene. Erstens: Wann war ich heute emotional intelligent — bewusst, reguliert, empathisch? Zweitens: Wann war ich heute weniger intelligent — reaktiv, unbewusst, unkontrolliert? Drittens: Was nehme ich daraus für morgen mit?

Die wöchentliche Vertiefung: Einmal pro Woche nimmst du dir dreißig Minuten für eine tiefere Reflexion. Welche emotionalen Muster haben sich diese Woche gezeigt? Welche Trigger waren aktiv? Wie hat sich meine Regulation entwickelt? Was braucht mehr Aufmerksamkeit?

Die Beziehungspraxis: Wähle eine wichtige Beziehung — Partnerschaft, Freundschaft, Kollegenbeziehung — und mache sie bewusst zum Übungsfeld. Kommuniziere emotionaler, höre empathischer zu, führe Konflikte bewusster, repariere schneller. Die Veränderung in einer Beziehung strahlt auf alle anderen aus.

Die größte Gefahr auf dem EQ-Weg: Perfektionismus. Du wirst weiterhin überreagieren, Trigger erleben, Fehler in der Kommunikation machen und dich manchmal fragen, ob du überhaupt Fortschritte machst. Das ist normal. Emotionale Intelligenz ist kein Zustand, den du erreichst — sie ist eine Richtung, in die du gehst. Jeder bewusste Moment zählt, auch wenn auf den bewussten Moment ein unbewusster folgt.`,
          uebung: {
            titel: 'Tägliche EQ-Routine',
            anleitung: `Gestalte deine persönliche tägliche EQ-Routine:

Morgens (1 Min):
Mein emotionaler Check: ___
Meine Intention für heute: ___

Mittags (1 Min):
Meine Reflexionsfrage: ___

Abends (5 Min):
Wann war ich heute emotional intelligent? ___
Wann nicht? ___
Was nehme ich mit für morgen? ___

Wöchentlich (Welcher Tag? ___):
30 Min tiefere Reflexion über emotionale Muster.

Starte morgen. Halte vier Wochen durch. Dann vergleiche deine EQ-Selbsteinschätzung vom Anfang des Kurses mit deiner heutigen.`,
            dauer: '10 Min',
          },
        },
        {
          id: 'P12-M6-L3',
          titel: 'Dein Weg der Emotionalen Intelligenz',
          inhalt: `Du hast die fünf Kernkompetenzen der emotionalen Intelligenz kennengelernt und geübt — Selbstwahrnehmung, Selbstregulation, Motivation, Empathie und soziale Kompetenz. Du hast die neurobiologischen Grundlagen verstanden, deine emotionalen Muster und Trigger identifiziert, Regulationstechniken gelernt, deine Empathie differenziert und deine kommunikativen Fähigkeiten erweitert.
...
Der Kreis schließt sich: Emotionale Intelligenz beginnt und endet bei dir. Du kannst anderen nur so tief helfen, wie du selbst gegangen bist. Du kannst andere nur so weit begleiten, wie du selbst bereit bist zu gehen. Deine emotionale Entwicklung ist dein größtes Geschenk an deine Klienten, deine Beziehungen und an dich selbst.

Dein Weg der Resonanz hat begonnen. Vertraue dem Prozess — und vertraue deinen Gefühlen. Sie sind keine Feinde — sie sind Wegweiser.`,
          uebung: {
            titel: 'Abschluss-Reflexion und Neubewertung',
            anleitung: `Wiederhole die EQ-Selbsteinschätzung vom Anfang des Kurses:

Selbstwahrnehmung: ___/10 (vorher: ___)
Selbstregulation: ___/10 (vorher: ___)
Motivation: ___/10 (vorher: ___)
Empathie: ___/10 (vorher: ___)
Soziale Kompetenz: ___/10 (vorher: ___)

Gesamt: ___/50 (vorher: ___)

Reflexion:
1. Was hat sich am meisten verändert? ___
2. Was war die tiefste Erkenntnis? ___
3. Was ist mein emotionaler blinder Fleck, an dem ich weiterarbeiten möchte? ___
4. Was ist meine tägliche EQ-Mindest-Praxis — auch an schlechten Tagen? ___

Bewahre beide Einschätzungen auf. Wiederhole in drei Monaten.
