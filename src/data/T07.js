const T07 = {
  ...
  module: [
    {
      id: 'T07-M1',
      titel: 'Grundlagen der Raumenergetik',
      lektionen: [
        {
          id: 'T07-M1-L1',
          titel: 'Räume als lebendige Energiefelder',
          inhalt: `Räume sind nicht leer — sie sind gefüllt mit Energie, Informationen und Erinnerungen. Jeder Raum, den Menschen bewohnen, nimmt die Energien seiner Bewohner auf und speichert sie: Freude und Streit, Liebe und Angst, Kreativität und Stagnation. Diese gespeicherten Energien beeinflussen jeden, der den Raum betritt — subtil, aber spürbar.

Du hast es selbst erlebt: Du betrittst ein Haus und fühlst dich sofort wohl — warm, einladend, sicher. Du betrittst ein anderes und spürst ein undefinierbares Unbehagen — obwohl der Raum schön eingerichtet ist. Der Unterschied liegt nicht in der Dekoration — er liegt in der energetischen Qualität des Raumes. Ein Raum, in dem gelacht, geliebt und gelebt wurde, strahlt eine andere Frequenz aus als einer, in dem gestritten, gelitten oder lange nicht gelebt wurde.
...
Der Raumspaziergang: Gehe langsam durch einen Raum und achte auf Veränderungen in deiner Körperwahrnehmung. Gibt es Stellen, an denen du dich wohler fühlst als an anderen? Bereiche, die sich schwer oder drückend anfühlen? Ecken, die sich stagnierend oder unbelebt anfühlen? Plätze, die dich magnetisch anziehen? Diese Unterschiede in der Raumqualität sind nicht zufällig — sie zeigen die energetische Landschaft des Raumes.

Die Handwahrnehmung: Halte deine Handflächen in verschiedenen Bereichen des Raumes — vor Wänden, in Ecken, über Möbelstücken, an Fenstern und Türen. Spüre die Unterschiede: Dichte und Dünnheit, Wärme und Kälte, Pulsation und Stillstand. Die Hände sind deine sensibelsten Wahrnehmungsorgane für Raumenergie — sie registrieren Nuancen, die dem Gesamtgefühl entgehen.
...
Der Austausch mit Mitbewohnern: Wenn du nicht allein wohnst, sprich mit den Menschen, die den Raum mit dir teilen. Oft decken sich die Eindrücke überraschend: \"Ja, in dieser Ecke sitze ich auch nie gern.\" Solche Gespräche schärfen die gemeinsame Achtsamkeit für den geteilten Raum — und machen die Raumpflege zu einem verbindenden Projekt.`
    ...
    {
      id: 'T07-M2',
      titel: 'Methoden der Raumreinigung',
      lektionen: [
        {
          id: 'T07-M2-L1',
...
Die Intensität anpassen: Leichte Reinigung — Palo Santo oder mildes Harz, einmaliger Durchgang. Mittlere Reinigung — Salbei oder Beifuß, zwei Durchgänge. Intensive Reinigung — starke Mischung, mehrere Durchgänge, eventuell über mehrere Tage. Die Intensität richtet sich nach dem Grad der Belastung, den du in der Analyse festgestellt hast.

Sicherheitshinweise: Nicht in Räumen mit Rauchmeldern ohne Vorkehrungen räuchern. Kein offenes Feuer unbeaufsichtigt lassen. Glühende Reste in feuerfestem Gefäß entsorgen. Bei Atemwegserkrankungen der Bewohner: sanftere Methoden wählen oder nur bei geöffneten Fenstern und Abwesenheit räuchern.`
        },
        {
          id: 'T07-M2-L2',
...
Die Technik: Gehe mit dem Klanginstrument durch den Raum, wie beim Räuchern. Spiele in jede Ecke, an jede Wand, über jedes Möbelstück. Höre auf den Klang: In belasteten Bereichen klingt das Instrument oft dumpfer, kürzer oder dissonanter. In freien Bereichen klingt es klar, lang und harmonisch. Der Klang zeigt dir die Raumqualität und reinigt sie gleichzeitig.

Wasserreinigung nutzt die reinigende und informationstragende Qualität des Wassers. Salzwasserschalen — Schalen mit Wasser und grobem Meersalz — werden in belasteten Ecken aufgestellt und über Nacht stehen gelassen. Das Salzwasser absorbiert negative Energie. Am nächsten Tag wird das Wasser ins Abwasser geschüttet — nie in den Garten. Sprühflaschen mit energetisiertem Wasser — Quellwasser mit einigen Tropfen ätherischem Öl — werden in den Raum gesprüht, um die Atmosphäre aufzufrischen. Besonders wirksam nach der Grundreinigung als leichtes Auffrischungsritual.

Lichtreinigung nutzt natürliches und künstliches Licht: Sonnenlicht ist der kraftvollste natürliche Reiniger — Fenster öffnen, Vorhänge zurückziehen, Sonnenlicht in alle Bereiche lassen. Kerzen erzeugen lebendiges, flackerndes Licht, das Stagnation aufbricht und dem Raum Wärme gibt. Kristalle — Bergkristall, Amethyst, schwarzer Turmalin — werden im Raum platziert, um die Lichtenergie zu bündeln und zu verteilen.

Die Kombination verschiedener Methoden verstärkt die Wirkung: Ein typisches Reinigungsprotokoll könnte sein: Zuerst Klangreinigung mit Klangschale (löst die Verdichtungen), dann Räuchern mit Salbei (transformiert die gelöste Energie), dann Lüften (trägt die alte Energie hinaus), abschließend Salzwasserschalen über Nacht (absorbiert Restbelastung). Am nächsten Tag: Kerze anzünden und den Raum segnen.`
        },
        {
          id: 'T07-M2-L3',
          titel: 'Energetische Reinigung ohne Hilfsmittel',
          inhalt: `Die kraftvollste Reinigungsmethode benötigt kein einziges Hilfsmittel — sie nutzt deine eigene Energie, deine Intention und deine Verbindung zum Raum. Die energetische Reinigung ohne Hilfsmittel ist die schnellste, flexibelste und am wenigsten auffällige Methode — du kannst sie in einem Hotelzimmer ebenso einsetzen wie in einem Büro, ohne dass jemand etwas bemerkt.

Die Grundtechnik — die Lichtflutung: Stelle dich in die Mitte des Raumes. Erden dich. Öffne dein Kronenchakra nach oben und stelle dir vor, wie reines, weißes oder goldenes Licht von oben durch dich hindurch in den Raum strömt. Lass das Licht den gesamten Raum füllen — jede Ecke, jeden Winkel, jede Nische. Visualisiere, wie das Licht alle dunklen, schweren, stagnierenden Energien auflöst und transformiert. Halte diese Visualisierung drei bis fünf Minuten, während du ruhig und tief atmest. Öffne dann in deiner Vorstellung die Wände und lass die transformierte Energie abfließen.

Die Atemreinigung: Stehe im Raum und atme bewusst ein und aus. Mit jeder Einatmung nimmst du die Raumenergie in dich auf — nicht um sie zu speichern, sondern um sie durch dein eigenes System zu transformieren. Mit jeder Ausatmung sendest du gereinigte, harmonische Energie in den Raum zurück. Diese Methode erfordert einen starken, gereinigten eigenen Energiekörper — sie ist nicht für Anfänger empfohlen, die noch nicht sicher zwischen eigener und fremder Energie unterscheiden können.
...
Die Kombination mit physischer Reinigung: Die energetische Wirkung wird verstärkt, wenn sie mit einer gründlichen physischen Reinigung einhergeht — Putzen, Aufräumen, Ausmisten. Ein physisch sauberer Raum ist leichter energetisch zu reinigen als ein verschmutzter. Putze und miste gründlich aus, bevor du energetisch reinigst — die physische Klärung ist die halbe Arbeit.`
    ...
    {
      id: 'T07-M3',
      titel: 'Raumharmonisierung und Raumgestaltung',
      lektionen: [
        {
          id: 'T07-M3-L1',
          titel: 'Den Energiefluss im Raum optimieren',
          inhalt: `Nach der Reinigung kommt die Harmonisierung — die bewusste Gestaltung des Energieflusses, damit der Raum seine Bewohner optimal unterstützt. Ein harmonischer Raum hat einen natürlichen Energiefluss — Energie tritt ein, zirkuliert, nährt und fließt ab, ohne zu stagnieren oder zu rasen.

Die Grundprinzipien des Energieflusses: Energie folgt der Aufmerksamkeit — wohin der Blick geht, fließt die Energie. Ein Raum, der den Blick natürlich durch sich hindurchführt, hat einen guten Fluss. Ein Raum, der den Blick blockiert — durch massive Möbel, verschlossene Türen oder dunkle Ecken —, staut die Energie. Energie braucht Eingang und Ausgang — ein Raum mit nur einem Zugang stagniert leichter als einer mit mehreren Öffnungen. Fenster und Türen sind die natürlichen Atempunkte des Raumes.
...
Symbole und Schutzsymbole: Die Blume des Lebens — ein universelles Harmoniemuster, das die Raumenergie ordnet. Platziert als Aufkleber, Bild oder Untersetzer in zentraler Position. Schutzsymbole aus verschiedenen Traditionen — die Verwendung muss respektvoll und kulturell sensibel sein. Eigene Schutzintention — ein persönlicher Satz oder ein Gebet, das beim Betreten des Raumes gesprochen wird: „Dieser Raum ist geschützt und nur für Energien zugänglich, die dem höchsten Wohl dienen."

Pflanzenschutz: Lebende Pflanzen reinigen nicht nur die Luft, sondern auch die Raumenergie. Efeututen und Grünlilien filtern Schadstoffe und beleben die Atmosphäre. Aloe Vera und Sansevieria stärken die schützende Energie. Rosmarin und Lavendel in Töpfen verbreiten reinigende Düfte. Kräutertöpfe auf der Fensterbank bilden einen lebendigen Schutzschild.
...
Die Anordnung von Kraft-Objekten: Bestimmte Gegenstände tragen eine eigene Energie und können den Raum gezielt aufladen. Familienfotoa in liebevoller Anordnung stärken die Bindungsenergie. Kunstwerke, die den Bewohner inspirieren, heben die kreative Schwingung. Symbole der eigenen Spiritualität — eine Buddhafigur, ein Kreuz, eine Metatron-Würfel-Grafik — verankern die spirituelle Verbindung im physischen Raum. Ein persönlicher Altar — ein kleiner, bewusst gestalteter Bereich mit bedeutsamen Gegenständen — ist das kraftvollste Raumgestaltungselement überhaupt.

Die saisonale Raumanpassung: Räume profitieren davon, mit den Jahreszeiten gestaltet zu werden — hellere Farben im Frühling, kühlendes Blau im Sommer, warme Erdtöne im Herbst, gemütliche Texturen im Winter. Diese Anpassung folgt dem natürlichen Rhythmus und hält den Raum lebendig.`
        }
      ]
    },
    {
